...
The three platforms have field tags with different names when
downloading the data. In this case, the field tag homogenization process
follows the [Web of Science Core Collection field
...
The primary and necessary variables to run a bibliometric analysis
suggested in the [bibliometrix
package](https://www.bibliometrix.org/vignettes/Data-Importing-and-Converting.html)
were first identified. However, when merging the three databases, it was
found that the raw formats contained a different number of variables.
For example, the document downloaded from the Web of Science contained
[73
...
and Dimensions [30](https://www.dropbox.com/scl/fi/0t01j093rwtsqxozna9dj/col_names_dim.xlsx?dl=0&rlkey=o87k0k0ddy3cy2ga0ugyy0u4k). Therefore, we proceeded to select variables in common
between the three platforms, obtaining a database with [29 variables](https://www.dropbox.com/scl/fi/ls7et6b55epo5g5t5ecmk/colnames_M.xlsx?dl=0&rlkey=j0we18gy90mnnlfawnp00jlxq) as a
result.
