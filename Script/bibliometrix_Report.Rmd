...
```{r Co-citation network, comment=NA, fig.height=8, fig.width=8}
#NetMatrix <- biblioNetwork(all_isi, analysis = "co-citation", network = "references", sep = ";")

NetMatrix <- biblioNetwork(n_2p, analysis = "coupling", network = "references", sep = ";", shortlabel = T)
net=networkPlot(NetMatrix, n = 30, Title = "Co-Citation Network", type = "fruchterman", size.cex=TRUE, size=20, remove.multiple=FALSE, labelsize=5,edgesize = 10, edges.min=5, label = T)
```
