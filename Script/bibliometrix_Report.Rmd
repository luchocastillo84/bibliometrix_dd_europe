...
# create a list or a vector with the names of 
# the .txt files that were downloaded from WoS

#tot_files <- c("wos_1_500.txt", "wos_501_1000.txt", 
              # "wos_1001_1500.txt", "wos_1501_2000.txt", 
              # "wos_2001_2500.txt", "wos_2501_3000.txt",
               #"wos_3001_3337.txt")

wos_1_500 <- read.delim(here("Data", "Raw", "wos_1_500.txt"), header = T, sep = "\t")
wos_501_1000 <- read.delim(here("Data", "Raw", "wos_501_1000.txt"), header = T, sep = "\t")
wos_1001_1500 <- read.delim(here("Data", "Raw", "wos_1001_1500.txt"), header = T, sep = "\t")
wos_1501_2000 <- read.delim(here("Data", "Raw", "wos_1501_2000.txt"), header = T, sep = "\t")
wos_2001_2500 <- read.delim(here("Data", "Raw", "wos_2001_2500.txt"), header = T, sep = "\t")
wos_2501_3000 <- read.delim(here("Data", "Raw", "wos_2501_3000.txt"), header = T, sep = "\t")
wos_3001_3337 <- read.delim(here("Data", "Raw", "wos_3001_3337.txt"), header = T, sep = "\t")


tot_wos_3337 <- rbind(wos_1_500, wos_501_1000, 
               wos_1001_1500, wos_1501_2000, 
              wos_2001_2500, wos_2501_3000,
               wos_3001_3337)
...
M <- convert2df(here("Data", "Processed", "text_m.txt"), 
